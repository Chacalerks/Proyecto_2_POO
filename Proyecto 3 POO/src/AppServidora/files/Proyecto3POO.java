...
public class Proyecto3POO {
    public static void main(String[] args) {
        ...
        lista.add(new Alimento("PRN-009", "Costillas en salsa de mostaza, kétchup y miel", "Costillas al horno, bañadas en salsa de mostaza, kétchup y miel",1200,6,260,130,5000,"src\\img\\catalago\\costillas.png"));
